...
export default function CustomerFormModal({ open, onClose, data }: any) {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        ...
        <input {...register("cnic")} placeholder="CNIC" className="input" />
        {errors.cnic && <p className="text-red-500 text-xs">{errors.cnic.message as string}</p>}
